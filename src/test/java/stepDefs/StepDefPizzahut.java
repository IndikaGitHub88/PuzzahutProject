...
Hooks.test.log(LogStatus.PASS,"I enter the location as");
    ...
    select.click();
     ...
     //tabpizza = driver.findElement(By.xpath("//*[@id=\"app\"]/div/div[1]/div[1]/div[3]/div[1]/div/a[2]"));
     //tabpizza.click();
     //driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(2000));
      //}
}
...
public void i_should_see_the_pizza_is_added_to_the_cart(String  Margherita) {
	...
	basket.click();
	//boolean flag=Basket.isDisplayed();
	//System.out.println("I see the Margherita pizza in basket: " +flag);
driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(3000));
...
Mobilenum.sendKeys("abc@xyz.com");
